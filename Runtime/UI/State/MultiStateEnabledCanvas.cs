...
#if !UNITY_2019
    public class MultiStateEnabledCanvas : MultiStateEnabledCanvasGeneric<State.State> {}
#else
    public class MultiStateEnabledCanvas : CanvasComponent, IMultiStateListener
    {
